...
<div class="container my-5">
    <div class="row align-items-center mb-5 pb-4">
        <div class="col-md-6">
            <span class="badge rounded-pill bg-light text-success px-3 py-2 mb-3 shadow-sm border">{{ __("L'aventure vous attend") }}</span>
            <h1 class="display-4 fw-bold" style="color: #2d5a27;">{{ __('À propos de') }} <span style="color: #4CAF50;">CompasSport</span></h1>
            <p class="lead text-muted mt-3 shadow-none">
                {{ __("Votre partenaire de confiance pour explorer les paysages magnifiques du Maroc et d'ailleurs.") }}
                <br><small class="text-secondary" style="font-size: 0.9rem;">{{ __("Plus qu'une boutique, une communauté de passionnés.") }}</small>
            </p>
        </div>
    ...
    <div class="row text-center g-4 mb-5 py-5 border-top border-bottom bg-light rounded-4">
        <div class="col-6 col-md-3">
            ...
            <p class="text-muted small">{{ __('Articles Outdoor') }}</p>
        </div>
        <div class="col-6 col-md-3">
            <h2 class="fw-bold mb-0" style="color: #2d5a27;">100%</h2>
            <p class="text-muted small">{{ __('Qualité Testée') }}</p>
        </div>
        <div class="col-6 col-md-3">
            <h2 class="fw-bold mb-0" style="color: #2d5a27;">24h/48h</h2>
            <p class="text-muted small">{{ __('Livraison Rapide') }}</p>
        </div>
        <div class="col-6 col-md-3">
            <h2 class="fw-bold mb-0" style="color: #2d5a27;">+2000</h2>
            <p class="text-muted small">{{ __('Clients Heureux') }}</p>
        </div>
    </div>
    ...
    <div class="row g-4 mb-5">
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm p-4 text-center about-card">
                ...
                <h3 class="h5 fw-bold mt-2">{{ __('Notre Mission') }}</h3>
                <p class="text-muted small mb-0">
                    {{ __('Accompagner vos aventures les plus intenses avec du matériel sur lequel vous pouvez compter à 100%.') }}
                </p>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm p-4 text-center about-card featured">
                ...
                <h3 class="h5 fw-bold mt-2">{{ __('Notre Spécialité') }}</h3>
                <p class="text-muted small mb-0">
                    {{ __('Experts passionnés de randonnée et camping, nous sélectionnons le meilleur pour le terrain marocain.') }}
                </p>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm p-4 text-center about-card">
                ...
                <h3 class="h5 fw-bold mt-2">{{ __('Nos Valeurs') }}</h3>
                <p class="text-muted small mb-0">
                    {{ __('Durabilité et respect de la nature sont au cœur de chaque produit que nous proposons.') }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="mt-5 p-5 text-center bg-dark text-white shadow-lg overflow-hidden position-relative" style="border-radius: 25px; background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=1000&q=80'); background-size: cover; background-position: center;">
        <div class="position-relative" style="z-index: 2;">
            <h2 class="mb-4 display-6 fw-bold text-uppercase">{{ __('Prêt pour votre prochaine aventure ?') }}</h2>
            <p class="mb-4 opacity-75">{{ __("Rejoignez des milliers d'explorateurs dès aujourd'hui.") }}</p>
            <a href="/" class="btn btn-success btn-lg px-5 py-3 rounded-pill shadow-sm fw-bold border-0" style="background-color: #4CAF50;">{{ __('Découvrir la collection') }}</a>
        </div>
    </div>
</div>
